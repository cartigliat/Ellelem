...
namespace ollamidesk.RAG.ViewModels
{
	public class RagSettingsViewModel : ViewModelBase
	{
			...
			Window window)
		{
			...
			_diagnostics.Log(DiagnosticLevel.Info, "RagSettingsViewModel", "Settings view model initialized");
		}
		...
		private async void SaveAndClose()
		{
			try
			{
				...
				_diagnostics.Log(DiagnosticLevel.Info, "RagSettingsViewModel", "Settings saved successfully");
		...
		private async void ResetToDefaults()
		{
			...
			try
			{
				...
				_diagnostics.Log(DiagnosticLevel.Info, "RagSettingsViewModel", "Settings reset to defaults");
			}
			catch (Exception ex)
			{
				_diagnostics.Log(DiagnosticLevel.Error, "RagSettingsViewModel",
