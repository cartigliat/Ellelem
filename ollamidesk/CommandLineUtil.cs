...
{
    /// <summary>
    /// Utility class for executing command line operations
    /// </summary>
    public static class CommandLineUtil
    {
        ...
        public static async Task<(string output, string error)> ExecuteCommandAsync(string fileName, string arguments)
        {
